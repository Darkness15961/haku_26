-- HAKU - Fase 8.5 del MVP de Rutas.
--
-- Desacopla las escrituras de Rutas del procesamiento espacial. Crear o
-- guardar una Ruta sin recorrido real no debe depender de ST_AsGeoJSON ni de
-- casts de trazado. El trazado sigue siendo parte del detalle/mapa y se guarda
-- solo mediante guardar_trazado_ruta_propia().
