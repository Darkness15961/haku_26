-- Bandeja de chat en una sola llamada: privado + comunidad + salida.
-- Evita el patrón N+1 de buscar sala, roster, último mensaje y no leídos.
...
COMMENT ON FUNCTION public.listar_bandeja_chat() IS
  'Bandeja contextual del usuario en una sola consulta; incluye salas creables por admin/organizador.';
