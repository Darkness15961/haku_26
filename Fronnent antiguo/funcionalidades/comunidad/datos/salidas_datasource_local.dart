...
class SalidasDataSourceLocal {
  ...
  late final List<ModeloSalida> _salidas = [
    ...
    ModeloSalida(
      id: 's9',
      lugarId: 'rausana_canchis',
      lugarNombre: 'Rausana (Sicuani)',
      organizador: 'Diego',
      fecha: DateTime.now().add(const Duration(days: 9)),
      hora: '6:00 AM',
      puntoEncuentro: 'Plaza Sicuani',
      cupos: 8,
      inscritos: 2,
      minimo: 3,
      dificultad: 'Moderada',
      ...
      comunidadId: 'com_trekkers',
      cuposGrupo: 3,
      inscritoIds: const ['diegoandes', 'yo'],
      checkinIds: const [],
    ),
    ModeloSalida(
      id: 's10',
      lugarId: 'laguna_pomacanchi',
      lugarNombre: 'Laguna de Pomacanchi',
      organizador: 'Ana',
      fecha: DateTime.now().add(const Duration(days: 11)),
      hora: '5:00 AM',
      puntoEncuentro: 'Terminal Acomayo',
      cupos: 10,
      inscritos: 4,
      minimo: 4,
      dificultad: 'Fácil',
      ...
      comunidadId: 'com_fotos',
      cuposGrupo: 4,
      inscritoIds: const ['sofiatrek', 'camilarios', 'mariaq', 'yo'],
      checkinIds: const [],
    ),
    ModeloSalida(
      id: 's11',
      lugarId: 'huanca_paruro',
      lugarNombre: 'Santuario del Señor de Huanca',
      organizador: 'Lucía',
      fecha: DateTime.now().add(const Duration(days: 14)),
      hora: '7:00 AM',
      puntoEncuentro: 'Plaza San Blas',
      cupos: 12,
      inscritos: 5,
      minimo: 4,
      dificultad: 'Fácil',
      ...
      comunidadId: 'com_fogon',
      cuposGrupo: 4,
      inscritoIds: const ['mariaq', 's1', 's3', 'yo', 'haku'],
      checkinIds: const [],
    ),
    ModeloSalida(
      id: 's12',
      lugarId: 'toro_pueblo_chumbivilcas',
      lugarNombre: 'Toropukllay (ensayo)',
      organizador: 'Carlos',
      fecha: DateTime.now().add(const Duration(days: 18)),
      hora: '2:00 PM',
      puntoEncuentro: 'Plaza Santo Tomás',
      cupos: 15,
      inscritos: 6,
      minimo: 5,
      dificultad: 'Fácil',
      ...
      comunidadId: 'com_trekkers',
      cuposGrupo: 5,
      inscritoIds: const ['diegoandes', 's2', 'sofiatrek', 'yo', 'haku', 'camilarios'],
      checkinIds: const [],
    ),
    ModeloSalida(
      id: 's13',
      lugarId: 'sillustani_espinar',
      lugarNombre: 'Chullpas de Espinar',
      organizador: 'Camila',
      fecha: DateTime.now().add(const Duration(days: 16)),
      hora: '8:00 AM',
      puntoEncuentro: 'Plaza Yauri',
      cupos: 8,
      inscritos: 3,
      minimo: 3,
      dificultad: 'Moderada',
      ...
      comunidadId: 'com_fotos',
      cuposGrupo: 3,
      inscritoIds: const ['camilarios', 'mariaq', 'yo'],
      checkinIds: const [],
    ),
  ];
